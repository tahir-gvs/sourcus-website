...
class Saasland_register_theme {
	...
	function admin_error() {
		$out = '<div class="error"><p>' . sprintf( wp_kses_post( __( 'The %s theme needs to be registered. %sRegister Now%s', 'saasland' ) ), 'Saasland', '<a href="' . admin_url( 'admin.php?page=saasland') . '">' , '</a>' ) . '</p></div>';
