 ...
 * @since 1.7.0
 */
class Saasland_hero_seo extends Widget_Base {
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center seo_banner_content">
                            <?php if(!empty($settings['title'])) : ?>
                                <<?php echo $title_tag; ?> class="title wow fadeInUp" data-wow-delay="0.3s"> <?php echo wp_kses_post(nl2br($settings['title'])); ?> </<?php echo $title_tag; ?>>
                            <?php endif; ?>
