<section class="event_banner_area">
    ...
    if ( !empty( $settings['bg_image_stl2']['url'] ) ) { ?>
        <div class="parallax-effect" style="background: url( <?php echo esc_url( $settings['bg_image_stl2']['url'] ) ?> );"></div>
        <?php
    } ?>
    <div class="container">
        <div class="event_banner_content">
            ...
            <?php
                ...
                if ( !empty( $settings['title'] ) ) {
                    echo '<'.$title_tag.' class="saasland_html_class_color wow fadeInUp" data-wow-delay="0.8s">' . wp_kses_post( $settings['title'] ) . '</'.$title_tag.'>';
                }
