    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'featured_img_sec', [
                ...
                'condition' => [
                    'style' => ['style_01', 'style_02', 'style_04', 'style_07', 'style_08'],
                ]
            ]
        );
        ...
        $this->add_control(
            'btn_border_color', [
                ...
                'condition' => [
                    'style' => [ 'style_03', 'style_07', 'style_08' ]
                ]
            ]
        );
        ...
        $this->start_controls_tab(
            ...
            [
                ...
                'condition' => [
                    'style' => ['style_02', 'style_03', 'style_05', 'style_07', 'style_08']
                ]
            ]
        );
        ...
        $this->add_control(
            'hover_bg_color', [
                ...
                'condition' => [
                    'style' => ['style_02', 'style_03', 'style_05', 'style_06', 'style_07', 'style_08']
                ]
            ]
        );
        ...
        $this->add_control(
            'bg_color', [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .erp_call_action_area' => 'background: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'sec_padding', [
                ...
                'condition' => [
                    'style' => ['style_01', 'style_03', 'style_04', 'style_07', 'style_08']
                ],
                'default' => [
