 ...
 * @since 1.7.0
 */
class Saasland_hero_app extends Widget_Base {
            ...
            <div class="col-lg-7">
                <div class="app_banner_contentmt mt_40">
                    ...
                    foreach ($buttons as $button) {
                        echo "<a href='{$button['btn_url']['url']}' class='btn_hover mt_30 app_btn wow fadeInLeft elementor-repeater-item-{$button['_id']}'> {$button['btn_title']} </a>";
                    }
                    ?>
                </div>
            </div>
