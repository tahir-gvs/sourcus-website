 ...
 * @since 1.7.0
 */
class Saasland_tabs_horizontal extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Horizontal Tabs', 'saasland-hero' );
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
            'circle_shape_color', [
                'label' => esc_html__( 'Circle Color', 'rogan-core' ),
                'type' => Controls_Manager::COLOR,
                'scheme' => [
                    'type' => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
                    ...
                    <div class="tab_img_info">
                        ...
                        foreach ( $tabs as $index => $item ) :
                            ...
                            if(!empty($item['featured_image']['url'])) :
                                ?>
                                <div class="tab_img <?php echo esc_attr($active) ?>" id="tab_<?php echo esc_attr($index); ?>">
