 ...
 * @since 1.7.0
 */
class Saasland_single_feature extends Widget_Base {
...
// ------------------------------  Title ------------------------------
    ...
    protected function render()
    {
        ...
        <div class="payment_features_item text-<?php echo esc_attr($settings['text_align']) ?>">
            ...
            <a href="<?php echo esc_url($settings['btn_url']['url']) ?>" <?php saasland_is_external($settings['btn_url']) ?> class="learn_btn_two">
