 ...
 * @since 1.7.0
 */
class Saasland_prototype_features extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			'color_title', [
				...
				'selectors' => [
					'{{WRAPPER}} .f_600.t_color3.l_height40.text-center.mb_90' => 'color: {{VALUE}};',
				],
			]
        );
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
				...
				'selector' => '{{WRAPPER}} .f_600.t_color3.l_height40.text-center.mb_90',
			]
		);
