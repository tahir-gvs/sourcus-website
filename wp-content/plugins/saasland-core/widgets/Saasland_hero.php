...
class Saasland_hero extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'style', [
                ...
                'label_block' => true,
                'options' => [
                    'style_01' => esc_html__( 'Style 01 (Mail)', 'saasland-core' ),
                    'style_02' => esc_html__( 'Style 02 (Digital Marketing)', 'saasland-core' ),
                    'style_03' => esc_html__( 'Style 03 (Cloud)', 'saasland-core' ),
                    'style_04' => esc_html__( 'Style 04 (Dark)', 'saasland-core' ),
                    'style_05' => esc_html__( 'Style 05 (Startup)', 'saasland-core' ),
                    'style_06' => esc_html__( 'Style 06 (Payment processing)', 'saasland-core' ),
                    'style_07' => esc_html__( 'Style 07 (HR Management)', 'saasland-core' ),
                    'style_08' => esc_html__( 'Style 08 (Hosting)', 'saasland-core' ),
                    'style_09' => esc_html__( 'Style 09 (POS)', 'saasland-core' ),
                    'style_10' => esc_html__( 'Style 10 (Analytics)', 'saasland-core' ),
                    'style_11' => esc_html__( 'Style 11 (Demo Landing)', 'saasland-core' ),
                    'style_12' => esc_html__( 'Style 12 (Chat)', 'saasland-core' ),
                    'style_13' => esc_html__( 'Style 13 (Event)', 'saasland-core' ),
                ],
                'default' => 'style_01'
            ]
        );
        ...
        $this->start_controls_section(
            'hero_pos_sec',
            [
                'label' => __( 'Slide Images', 'saasland-core' ),
                'condition' => [
                    'style' => 'style_09'
                ]
            ]
        ...
        $slides_images = new \Elementor\Repeater();
        $slides_images->add_control(
            'slides_img', [
        ...
        $this->add_control(
            'slide_images', [
                'label' => __( 'Slides', 'saasland-core' ),
                'type' => Controls_Manager::REPEATER,
                'title_field' => '{{{ slides_img }}}',
                'fields' => $slides_images->get_controls(),
            ]
        );
        ...
        $this->add_control(
            'mail_shape_img1', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/shape_02.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'mail_shape_img2', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/shape_03.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'mail_shape_img3', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/shape_01.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'payment_pro_shape_img', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/shape_home9.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'hr_management_shape', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/startup_shap.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'hos_shape1', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( '/images/home-hosting/line_01.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'hos_shape2', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( '/images/home-hosting/line_02.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'hos_shape3', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( '/images/home-hosting/line_03.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'hos_shape4', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( '/images/home-hosting/line_04.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'hos_shape5', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( '/images/home-hosting/line_05.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'hos_shape6', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( '/images/home-hosting/line_06.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'hos_shape7', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( '/images/home-hosting/line_07.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'hos_shape8', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( '/images/home-hosting/line_08.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'analytics_shape_img1', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/home-analytics/elements_one.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'analytics_shape_img2', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/home-analytics/elements_two.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'analytics_shape_img3', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/home-analytics/elements_three.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'analytics_shape_img4', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/home-analytics/elements_four.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'analytics_shape_img5', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/home-analytics/elements_five.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'analytics_shape_img6', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'images/home-analytics/elements_six.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'demo_shape1', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/images/demo-landing/circle-2.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'demo_shape2', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/images/demo-landing/shape_02.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'demo_shape3', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/images/demo-landing/shape_03.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'demo_shape4', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/images/demo-landing/shape_04.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'demo_shape5', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/images/demo-landing/shape_05.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'demo_shape6', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/images/demo-landing/shape_06.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'demo_shape7', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/images/demo-landing/shape_07.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'demo_shape8', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/images/demo-landing/shape_08.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'demo_shape9', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/images/demo-landing/dot.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'chat_shape1', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/chat/img/cloud.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'chat_shape2', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/chat/img/left_leaf.png', __FILE__)
                ]
            ]
        );
        ...
        $this->add_control(
            'chat_shape3', [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => plugins_url( 'heros/chat/img/right_leaf.png', __FILE__)
                ]
            ]
        );
    ...
    protected function render() {
        ...
        $slide_images = $settings['slide_images'];
        $title_tag = !empty($settings['title_html_tag']) ? $settings['title_html_tag'] : 'h2';

        if ( $settings['style'] == 'style_01' ) {
            include 'heros/part-hero-mail.php';
        }

        if ( $settings['style'] == 'style_02' ) {
            include 'heros/part-hero-digital-marketing.php';
        }

        if ( $settings['style'] == 'style_03' ) {
            include 'heros/part-hero-cloud.php';
        }

        if ( $settings['style'] == 'style_04' ) {
            include 'heros/part-hero-dark.php';
        }

        if ( $settings['style'] == 'style_05' ) {
            include 'heros/part-hero-startup.php';
        }

        if ( $settings['style'] == 'style_06' ) {
            include 'heros/part-hero-payment-processing.php';
        }

        if ( $settings['style'] == 'style_07' ) {
            include 'heros/part-hero-hr-management.php';
        }

        if ( $settings['style'] == 'style_08' ) {
            include 'heros/part-hero-hosting.php';
        }

        if ( $settings['style'] == 'style_09' ) {
            include 'heros/part-hero-pos.php';
        }

        if ( $settings['style'] == 'style_10' ) {
            include 'heros/part-hero-analytics-software.php';
        }
        ...
        if ( $settings['style'] == 'style_12' ) {
            include 'heros/chat/hero-chat.php';
        }

        if ( $settings['style'] == 'style_13' ) {
            include 'heros/event/hero-event.php';
        }
