                ...
                foreach ($table3 as $table) {
                    ...
                    <div class="col-lg-<?php echo esc_attr($settings['column']) ?> col-md-6">
                        <div class="analytices_price_item <?php echo esc_attr( $is_active ) ?> elementor-repeater-item-<?php echo $table['_id']; ?>">
                            ...
                            <?php echo !empty($table['btn_label']) ? '<a '.saasland_is_exno($table['btn_url'], false).' href="'.esc_url($table['btn_url']['url']) .'" class="er_btn er_btn_two elementor-repeater-item-' . $table['_id'] .'">' . $table['btn_label'] . '</a>' : ''; ?>
                        </div>
                    </div>
                    <?php
                }
