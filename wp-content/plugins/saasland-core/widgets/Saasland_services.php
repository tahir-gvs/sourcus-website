 ...
 * @since 1.7.0
 */
class Saasland_services extends Widget_Base {
            ...
            <div class="container custom_container p0">
                <div class="row service_info mt_70 mb_30">
                    ...
                    while($services->have_posts()) {
                        ...
                        $background_color = get_post_meta(get_the_ID(), 'icon_background_color', true);
                        $background_color2 = get_post_meta(get_the_ID(), 'icon_background_color2', true);
                ...
                <div class="service_carousel owl-carousel">
                    ...
                    while($services->have_posts()) {
                        ...
                        if ( !empty($settings['excerpt']) ) {
                            $excerpt = get_the_excerpt() ? saasland_limit_latter(get_the_excerpt(), $settings['excerpt'], '') : saasland_limit_latter(get_the_content(), $settings['excerpt'], '');
                        }
                        else {
                            $excerpt = get_the_excerpt() ? get_the_excerpt() : saasland_limit_latter(get_the_content(), 120, '');
                        }
                        ?>
                        <div class="service_item">
                            <div class="icon s_icon_one" style="<?php echo $bg_color.$shadow; ?>">
