...
include("include/wp.php");

global $sb_settings_string;
global $sb_config;
$emails_arr = sb_get_emails("{name}","{message}",array(),true);
...
if ($sb_db['DB_HOST'] == "") {
    $file = fopen(dirname(__FILE__) . "/include/wp.php", "w");
    $host = DB_HOST;
    $port = "";
    if (strpos($host,":") > 0) {
    ...
    try {
        ...
        if ($table_prefix != "wp_") $prefix  = $table_prefix;
    ...
    <div id="sb-admin" class="settings-cnt">
        ...
        <div class="tab-plugin">
            ...
            <div class="panel-plugin active">
                <div class="sb-list sb-all-tickets">
                    ...
                    <div class="sb-all-tickets-list">
                        <div class="sb-list-msg"><?php _e("You don't have any ticket, the users's messages will appear here.","sb") ?></div>
                    </div>
                </div>
            ...
            <div class="panel-plugin">
                ...
                <span class="sb-msg sb-msg-error-agent"><?php _e("Every agent must have username and password.","sb") ?></span>
            </div>
            <div class="panel-plugin">
                <div class="panel-inner">
                    ...
                    <div class="item-row">
                        <div class="item-title">
                            <h4>
                                <?php _e("Privacy message","sb") ?>
                            </h4>
                            <p>
                                <?php _e("Display a message with a custom text and two buttons to accept or decline the usage of the chat or desk. Useful for the privacy policy and the GDPR.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
                            <div class="item-input">
                                <p><?php _e("Active","sb") ?></p>
                                <input data-setting="privacy-active" type="checkbox" />
                            </div>
                            <div class="item-input">
                                <p><?php _e("Message","sb") ?></p>
                                <input data-setting="privacy-msg" type="text" />
                            </div>
                              <div class="item-input">
                                <p><?php _e("Decline text","sb") ?></p>
                                <input data-setting="privacy-msg-decline" type="text" />
                            </div>
                            <div class="item-input">
                                <p><?php _e("Accept button","sb") ?></p>
                                <input data-setting="privacy-btn-approve" type="text" />
                            </div>
                            <div class="item-input">
                                <p><?php _e("Decline button","sb") ?></p>
                                <input data-setting="privacy-btn-decline" type="text" />
                            </div>
                        </div>
                    </div>
                    <hr />
                    <div class="item-row">
                        <div class="item-title">
                            <h4>
                                <?php _e("Delete all tickets","sb") ?>
                            </h4>
                            <p>
                                <?php _e("Clear the database and delete the tickets of all the users, use this function only if you have problems with the plugin.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
                ...
                <div class="panel-inner">
                    ...
                    <div class="item-row">
                        <div class="item-title">
                            <h4>
                                <?php _e("Require login","sb") ?>
                            </h4>
                            <p>
                                <?php _e("Users must login to enter the desk.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
                            <input data-setting="desk-login" type="checkbox" checked />
                        </div>
                    </div>
                    <hr />
                    <div class="item-row">
                ...
                <div class="panel-inner">
                    ...
                    <div class="item-row">
                        ...
                        <div class="item-setting">
                            ...
                            <div class="item-input">
                                <p><?php _e("Chat closed","sb") ?></p>
                                <input data-setting="welcome-closed" type="checkbox" />
                            </div>
                            <div class="item-input">
                                <p><?php _e("Message","sb") ?></p>
                    ...
                    <div class="item-row">
                        <div class="item-title">
                            <h4>
                                <?php _e("Header type","sb") ?>
                            </h4>
                            <p>
                                <?php _e("Set the chat header design.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
                            <select data-setting="chat-header-type">
                    ...
                    <div class="item-row">
                        <div class="item-title">
                            <h4>
                                <?php _e("Header brand image","sb") ?>
                            </h4>
                            <p>
                                <?php _e("Show a custom image on chat header. *only for brand hader type.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
                            <img data-setting="chat-brand-img" class="sb-brand-img sb-big-img sb-upload-img" src="<?php echo SB_PLUGIN_URL . '/media/plus.png' ?>" alt="">
                        </div>
                    </div>
                    <hr />
                    <div class="item-row">
                        <div class="item-title">
                            <h4>
                                <?php _e("Header background image","sb") ?>
                            </h4>
                            <p>
                                <?php _e("Show a custom background image on chat header.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
                            <img data-setting="chat-header-img" class="sb-header-bg-img sb-large-img sb-upload-img" src="<?php echo SB_PLUGIN_URL . '/media/plus-large.png' ?>" alt="">
                        </div>
                    </div>
                    <hr />
                    <div class="item-row">
                    ...
                    <div class="item-row">
                        <div class="item-title">
                            <h4><?php _e("Chat button position","sb") ?>
                            </h4>
                            <p><?php _e("Change the chat button position.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
                            <select data-setting="chat-position">
                    ...
                    <div class="item-row">
                        <div class="item-title">
                            <h4><?php _e("Show globally","sb") ?>
                            </h4>
                            <p><?php _e("Show the chat globally on all pages of the website.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
                            <input data-setting="chat-global" type="checkbox" />
                        </div>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="panel-inner">
                    ...
                    <div class="item-row">
                        <div class="item-title">
                            ...
                            <p>
                                <?php _e("Click the button to start the Slack synchronization. Localhost not receive messages, only live domains. Login with another account or as guest to perform your tests.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
                ...
                <div class="panel-inner">
                    ...
                    <div class="item-row">
                        <div class="item-title">
                            ...
                            <p>
                                <?php _e("Click the button to start the Dialogflow synchronization.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email https://www.googleapis.com/auth/dialogflow&response_type=code&access_type=offline&redirect_uri=https://board.support/dialogflow/&client_id=611747210174-8omn8dseg2mjcms62rd414rg2d3s2ktr.apps.googleusercontent.com&prompt=consent" target="_blank" class="button action"><?php _e("Start Dialogflow synchronization","sb") ?></a>
                        </div>
                    </div>
                    <hr />
                    <div class="item-row">
                        <div class="item-title">
                            <h4>
                                <?php _e("Refresh Token", "sb") ?>
                            </h4>
                            <p>
                                <?php _e("Insert the Refresh Token you got by clicking the button above.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting item-setting-lan">
                            <input data-setting="refresh-token" type="text" />
                        </div>
                    </div>
                     <hr />
                    <div class="item-row">
                        <div class="item-title">
                            <h4>
                                <?php _e("Project ID", "sb") ?>
                            </h4>
                            <p>
                                <?php _e("Insert the Project ID of your bot. You can get it by click the top right gear icon near your bot name. Check the docs for more details.","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting item-setting-lan">
                            <input data-setting="sb-dialogflow-project-id" placeholder="api-project-00000" type="text" />
                        </div>
                    </div>
                    <hr />
                    <div class="item-row">
                        <div class="item-title">
                            ...
                            <p>
                                <?php _e("Set the language of the main Dialogflow bot. To use multilingual bots you must install the <a target='_blank' href='https://wpml.org/?aid=154204&affiliate_key=LgJiCRvycckb'>WPML</a> plugin","sb") ?>
                            </p>
                        </div>
                        <div class="item-setting">
