...
(function ($) {
    $(document).ready(function () {
        ...
        $("body").on("click", "#sb-btn-add-new-user,#sb-btn-add-new-agent", function () {
            ...
            var html = '<tr class="sb-new-item"><td><input class="sb-user-id" disabled type="text" value="' + getRandomInt(9999999, 99999999) + '" /></td>' +
        ...
        $("body").on("focusout", ".sb-table tbody tr:not(.sb-new-item) td input", function () {
            var val = $(this).val();
            if (val != "") {
        ...
        if (getURLParameter("page") == 'support-board' || is_php) {
            ...
            setInterval(function () {
                if (!isIntoConversation && (getURLParameter("page") == 'support-board' || is_php)) {
                    sb_get_tickets();
                }
            }, 5000);
        }
        ...
        $("body").on("click", ".sb-user-tickets .sb-submit", function () {
            if (!$(this).hasClass("disabled")) {
                ...
                if (msg != "" || files_html != "") {
                    ...
                    if (!is_php || isEmpty(agent)) {
                        agent = $(".sb-wp-agents").find("[value='" + $(".sb-wp-agents").val() + "']").attr("data-agent");
                    }
                    for (var i = 0; i < agents_arr.length; i++) {
